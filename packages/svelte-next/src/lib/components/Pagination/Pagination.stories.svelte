...
<Story name="Alot of pages and hidden labels" args={{ totalPages: 20, hideLabels: true }} />

<Story name="Custom labels" args={{ previousLabel: "I går", nextLabel: "I morgen" }} />

<Story name="Compact page-view and large size" args={{  totalPages: 10, compact: true, size: "lg" }} />