<script>
  ...
  /** @type {{multiple: any, inputId: any, placeholder: any, hasFilter: any, readOnly: any, removeOption: any, handleSelectControlClick: any, handleFilterChange: any, searchLabel: any, disabled: any, error: any, clearAll: any, clearable: any, size: any}} */
  let {
    multiple,
    inputId,
    placeholder,
